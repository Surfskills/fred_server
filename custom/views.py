...
class RequestViewSet(viewsets.ViewSet):
    ...
    lookup_field = 'shared_id'  # Define shared_id as the lookup field
    ...
    def get_queryset(self, request_type=None):
        ...
        software_requests = SoftwareRequest.objects.filter(user=user).annotate(
            ...
            'id', 'shared_id', 'title', 'project_description', 'request_type',
    ...
    def get_object_by_shared_id(self, shared_id):
        """
        Helper method to get an object by shared_id, ensuring it belongs to the current user
        """
        user = self.request.user
